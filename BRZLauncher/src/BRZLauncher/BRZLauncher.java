...
public class BRZLauncher {
    ...
    public static void main (String args[]) throws IOException, URISyntaxException {
    	...
    	/**
    	 * TODO
    	 * Extrai o arquivo zipado do servidor para uma pasta tempor�ria.
    	 */
    	extrairServidor();
    ...
    /**
     * TODO
     * Fun��o chamada quando o servidor � fechado.
     * Caso o servidor tenha sido fechado no meio de uma partida, o cliente deve ser punido com 15 minutos sem  poder jogar (verifica��o esta feita pelo servidor mestre).
     */
    public static void quandoServidorFechar() {
    	JOptionPane.showMessageDialog(BRZLauncher.frame, "O servidor foi fechado de forma inesperada.\n\nFechar o servidor durante uma partida resulta em puni��o. Caso tenha ocorrido algum crash, copie e envie o c�digo retornado via f�rum para que nossos desenvolvedores possam analis�-lo.");
    }
    	...
    	public void run() {
    		...
    		try {
    			...
    			while(true) {
    				...
    				System.out.println("[SA-MP Server] Nova conex�o vinda de: "+clientSocket.getInetAddress().getHostAddress());
    			}
    		} catch (Exception ex) {
    			if(serverSock != null) {
    				try {
